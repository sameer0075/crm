...
const typeToStepMap: { [key: string]: number } = {
  LEADS: 0,
  FOLLOW_UP_LEADS: 0,
  OPPORTUNITY: 1,
  FOLLOW_UP_OPPORTUNITY: 1,
  APPOINTMENTS: 2,
  DEALS: 3,
};
...
const Stepper = ({ data, appendLog, type }: StepperInterface) => {
  const currentStep = typeToStepMap[type] || 0;
    ...
    <section className="">
      <div className="rounded-lg bg-gradient-to-br from-white  via-white to-transparent shadow-lg  p-4 flex flex-col ">
        <ol className="flex pt-20 max-w-[500px] min-w-[500px] w-full mx-auto ">
          <li
            className={`flex w-full items-center ${currentStep >= 0 ? 'after:border-b after:border-[rgba(27,_162,_232,_0.90)]' : 'after:border-[#F3F3F3]'} after:content-[''] after:w-full after:h-1 after:border-4 after:inline-block`}
          >
            <span
              className={`relative flex items-center justify-center w-[16px] h-[16px] ${currentStep >= 0 ? 'bg-[rgba(27,_162,_232,_0.90)]' : 'bg-[#D6D3D6]'} rounded-full lg:h-[16px] lg:w-[16px] dark:bg-gray-700 shrink-0`}
            >
          ...
          <li
            className={`flex w-full items-center ${currentStep >= 1 ? 'after:border-b after:border-[rgba(27,_162,_232,_0.90)]' : 'after:border-[#F3F3F3]'} after:content-[''] after:w-full after:h-1 after:border-4 after:inline-block`}
          >
            <span
              className={`relative flex items-center justify-center w-[16px] h-[16px] ${currentStep >= 1 ? 'bg-[rgba(27,_162,_232,_0.90)]' : 'bg-[#D6D3D6]'} rounded-full lg:h-[16px] lg:w-[16px] dark:bg-gray-700 shrink-0`}
            >
              <div className="absolute bottom-4 flex flex-col items-center justify-center text-[#31AAE9]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            className={`flex w-full items-center ${currentStep >= 2 ? 'after:border-b after:border-[rgba(27,_162,_232,_0.90)]' : 'after:border-[#F3F3F3]'} after:content-[''] after:w-full after:h-1 after:border-4 after:inline-block`}
          >
            <span
              className={`relative flex items-center justify-center w-[16px] h-[16px] ${currentStep >= 2 ? 'bg-[rgba(27,_162,_232,_0.90)]' : 'bg-[#D6D3D6]'} rounded-full lg:h-[16px] lg:w-[16px] dark:bg-gray-700 shrink-0`}
            >
              <div className="absolute bottom-4 flex flex-col items-center justify-center text-[#31AAE9]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <h1 className="text-[14px]">Appointments</h1>
              </div>
            </span>
          </li>
          <li
            className={`flex w-full items-center ${currentStep >= 3 ? 'after:border-b after:border-[rgba(27,_162,_232,_0.90)]' : 'after:border-[#F3F3F3]'} after:content-[''] after:w-full after:h-1 after:border-4 after:inline-block`}
          >
            <span
              className={`relative flex items-center justify-center w-[16px] h-[16px] ${currentStep >= 3 ? 'bg-[rgba(27,_162,_232,_0.90)]' : 'bg-[#D6D3D6]'} rounded-full lg:h-[16px] lg:w-[16px] dark:bg-gray-700 shrink-0`}
            >
              <div className="absolute bottom-4 flex flex-col items-center justify-center text-[#31AAE9]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
